...
public class ModBlocks {
    ...
    public static final DeferredBlock<Block> UNKNOWN_MATERIAL_BLOCK = registerBlock("unknown_material_block",
            () -> new Block(BlockBehaviour.Properties.of()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "unknown_material_block")))
                    .requiresCorrectToolForDrops()
                    .strength(3f)
                    .sound(SoundType.STONE)));
    ...
    public static final DeferredBlock<Block> CORRUPTED_FLAG_BLOCK = registerBlock("corrupted_flag_block",
            () -> new Block(BlockBehaviour.Properties.of()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "corrupted_flag_block")))
                    .requiresCorrectToolForDrops()
                    .strength(4.5f)
                    .sound(SoundType.STONE)));
    ...
    public static final DeferredBlock<WallFlag> ABROSEXUAL_WALL_FLAG = registerBlock("abrosexual_wall_flag",
            () -> new WallFlag(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "abrosexual_wall_flag")))
                    .requiresCorrectToolForDrops()
                    .strength(0.5f)
                    .sound(SoundType.METAL)));
    ...
    public static final DeferredBlock<WallFlag> AGENDER_WALL_FLAG = registerBlock("agender_wall_flag",
            () -> new WallFlag(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "agender_wall_flag")))
                    .requiresCorrectToolForDrops()
                    .strength(0.5f)
                    .sound(SoundType.METAL)));
    ...
    public static final DeferredBlock<WallFlag> AROACE_WALL_FLAG = registerBlock("aroace_wall_flag",
            () -> new WallFlag(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "aroace_wall_flag")))
                    .requiresCorrectToolForDrops()
                    .strength(0.5f)
                    .sound(SoundType.METAL)));
    ...
    public static final DeferredBlock<WallFlag> AROMANTIC_WALL_FLAG = registerBlock("aromantic_wall_flag",
            () -> new WallFlag(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "aromantic_wall_flag")))
                    .requiresCorrectToolForDrops()
                    .strength(0.5f)
                    .sound(SoundType.METAL)));
    ...
    public static final DeferredBlock<WallFlag> ASEXUAL_WALL_FLAG = registerBlock("asexual_wall_flag",
            () -> new WallFlag(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "asexual_wall_flag")))
                    .requiresCorrectToolForDrops()
                    .strength(0.5f)
                    .sound(SoundType.METAL)));
    ...
    public static final DeferredBlock<WallFlag> BIGENDER_WALL_FLAG = registerBlock("bigender_wall_flag",
            () -> new WallFlag(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "bigender_wall_flag")))
                    .requiresCorrectToolForDrops()
                    .strength(0.5f)
                    .sound(SoundType.METAL)));
    ...
    public static final DeferredBlock<WallFlag> BISEXUAL_WALL_FLAG = registerBlock("bisexual_wall_flag",
            () -> new WallFlag(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "bisexual_wall_flag")))
                    .requiresCorrectToolForDrops()
                    .strength(0.5f)
                    .sound(SoundType.METAL)));
    ...
    public static final DeferredBlock<WallFlag> DEMIBOY_WALL_FLAG = registerBlock("demiboy_wall_flag",
            () -> new WallFlag(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "demiboy_wall_flag")))
                    .requiresCorrectToolForDrops()
                    .strength(0.5f)
                    .sound(SoundType.METAL)));
    ...
    public static final DeferredBlock<WallFlag> DEMIGIRL_WALL_FLAG = registerBlock("demigirl_wall_flag",
            () -> new WallFlag(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "demigirl_wall_flag")))
                    .requiresCorrectToolForDrops()
                    .strength(0.5f)
                    .sound(SoundType.METAL)));
    ...
    public static final DeferredBlock<WallFlag> DEMINONBINARY_WALL_FLAG = registerBlock("deminonbinary_wall_flag",
            () -> new WallFlag(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "deminonbinary_wall_flag")))
                    .requiresCorrectToolForDrops()
                    .strength(0.5f)
                    .sound(SoundType.METAL)));
    ...
    public static final DeferredBlock<WallFlag> DEMIROMANTIC_WALL_FLAG = registerBlock("demiromantic_wall_flag",
            () -> new WallFlag(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "demiromantic_wall_flag")))
                    .requiresCorrectToolForDrops()
                    .strength(0.5f)
                    .sound(SoundType.METAL)));
    ...
    public static final DeferredBlock<WallFlag> DEMISEXUAL_WALL_FLAG = registerBlock("demisexual_wall_flag",
            () -> new WallFlag(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "demisexual_wall_flag")))
                    .requiresCorrectToolForDrops()
                    .strength(0.5f)
                    .sound(SoundType.METAL)));
    ...
    public static final DeferredBlock<WallFlag> GAY_WALL_FLAG = registerBlock("gay_wall_flag",
            () -> new WallFlag(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "gay_wall_flag")))
                    .requiresCorrectToolForDrops()
                    .strength(0.5f)
                    .sound(SoundType.METAL)));
    ...
    public static final DeferredBlock<WallFlag> GENDERFLUID_WALL_FLAG = registerBlock("genderfluid_wall_flag",
            () -> new WallFlag(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "genderfluid_wall_flag")))
                    .requiresCorrectToolForDrops()
                    .strength(0.5f)
                    .sound(SoundType.METAL)));
    ...
    public static final DeferredBlock<WallFlag> GENDERFLUX_WALL_FLAG = registerBlock("genderflux_wall_flag",
            () -> new WallFlag(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "genderflux_wall_flag")))
                    .requiresCorrectToolForDrops()
                    .strength(0.5f)
                    .sound(SoundType.METAL)));
    ...
    public static final DeferredBlock<WallFlag> GENDERQUEER_WALL_FLAG = registerBlock("genderqueer_wall_flag",
            () -> new WallFlag(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "genderqueer_wall_flag")))
                    .requiresCorrectToolForDrops()
                    .strength(0.5f)
                    .sound(SoundType.METAL)));
    ...
    public static final DeferredBlock<WallFlag> GRAYROMANTIC_WALL_FLAG = registerBlock("grayromantic_wall_flag",
            () -> new WallFlag(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "grayromantic_wall_flag")))
                    .requiresCorrectToolForDrops()
                    .strength(0.5f)
                    .sound(SoundType.METAL)));
    ...
    public static final DeferredBlock<WallFlag> GRAYSEXUAL_WALL_FLAG = registerBlock("graysexual_wall_flag",
            () -> new WallFlag(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "graysexual_wall_flag")))
                    .requiresCorrectToolForDrops()
                    .strength(0.5f)
                    .sound(SoundType.METAL)));
    ...
    public static final DeferredBlock<WallFlag> INTERSEX_WALL_FLAG = registerBlock("intersex_wall_flag",
            () -> new WallFlag(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "intersex_wall_flag")))
                    .requiresCorrectToolForDrops()
                    .strength(0.5f)
                    .sound(SoundType.METAL)));
    ...
    public static final DeferredBlock<WallFlag> LESBIAN_WALL_FLAG = registerBlock("lesbian_wall_flag",
            () -> new WallFlag(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "lesbian_wall_flag")))
                    .requiresCorrectToolForDrops()
                    .strength(0.5f)
                    .sound(SoundType.METAL)));
    ...
    public static final DeferredBlock<WallFlag> NONBINARY_WALL_FLAG = registerBlock("nonbinary_wall_flag",
            () -> new WallFlag(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "nonbinary_wall_flag")))
                    .requiresCorrectToolForDrops()
                    .strength(0.5f)
                    .sound(SoundType.METAL)));
    ...
    public static final DeferredBlock<WallFlag> OMNISEXUAL_WALL_FLAG = registerBlock("omnisexual_wall_flag",
            () -> new WallFlag(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "omnisexual_wall_flag")))
                    .requiresCorrectToolForDrops()
                    .strength(0.5f)
                    .sound(SoundType.METAL)));
    ...
    public static final DeferredBlock<WallFlag> PANSEXUAL_WALL_FLAG = registerBlock("pansexual_wall_flag",
            () -> new WallFlag(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "pansexual_wall_flag")))
                    .requiresCorrectToolForDrops()
                    .strength(0.5f)
                    .sound(SoundType.METAL)));
    ...
    public static final DeferredBlock<WallFlag> POLYSEXUAL_WALL_FLAG = registerBlock("polysexual_wall_flag",
            () -> new WallFlag(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "polysexual_wall_flag")))
                    .requiresCorrectToolForDrops()
                    .strength(0.5f)
                    .sound(SoundType.METAL)));
    ...
    public static final DeferredBlock<WallFlag> PROGRESS_PRIDE_WALL_FLAG = registerBlock("progress_pride_wall_flag",
            () -> new WallFlag(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "progress_pride_wall_flag")))
                    .requiresCorrectToolForDrops()
                    .strength(0.5f)
                    .sound(SoundType.METAL)));
    ...
    public static final DeferredBlock<WallFlag> QUEER_WALL_FLAG = registerBlock("queer_wall_flag",
            () -> new WallFlag(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "queer_wall_flag")))
                    .requiresCorrectToolForDrops()
                    .strength(0.5f)
                    .sound(SoundType.METAL)));
    ...
    public static final DeferredBlock<WallFlag> RAINBOW_WALL_FLAG = registerBlock("rainbow_wall_flag",
            () -> new WallFlag(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "rainbow_wall_flag")))
                    .requiresCorrectToolForDrops()
                    .strength(0.5f)
                    .sound(SoundType.METAL)));
    ...
    public static final DeferredBlock<WallFlag> TRANSGENDER_WALL_FLAG = registerBlock("transgender_wall_flag",
            () -> new WallFlag(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "transgender_wall_flag")))
                    .requiresCorrectToolForDrops()
                    .strength(0.5f)
                    .sound(SoundType.METAL)));
    ...
    public static final DeferredBlock<FlagCarpet> ABROSEXUAL_FLAG_CARPET = registerBlock("abrosexual_flag_carpet",
            () -> new FlagCarpet(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "abrosexual_flag_carpet")))
                    .strength(0.2f)
                    .sound(SoundType.WOOL)));

    public static final DeferredBlock<FlagCarpet> AGENDER_FLAG_CARPET = registerBlock("agender_flag_carpet",
            () -> new FlagCarpet(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "agender_flag_carpet")))
                    .strength(0.2f)
                    .sound(SoundType.WOOL)));

    public static final DeferredBlock<FlagCarpet> AROACE_FLAG_CARPET = registerBlock("aroace_flag_carpet",
            () -> new FlagCarpet(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "aroace_flag_carpet")))
                    .strength(0.2f)
                    .sound(SoundType.WOOL)));

    public static final DeferredBlock<FlagCarpet> AROMANTIC_FLAG_CARPET = registerBlock("aromantic_flag_carpet",
            () -> new FlagCarpet(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "aromantic_flag_carpet")))
                    .strength(0.2f)
                    .sound(SoundType.WOOL)));

    public static final DeferredBlock<FlagCarpet> ASEXUAL_FLAG_CARPET = registerBlock("asexual_flag_carpet",
            () -> new FlagCarpet(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "asexual_flag_carpet")))
                    .strength(0.2f)
                    .sound(SoundType.WOOL)));

    public static final DeferredBlock<FlagCarpet> BIGENDER_FLAG_CARPET = registerBlock("bigender_flag_carpet",
            () -> new FlagCarpet(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "bigender_flag_carpet")))
                    .strength(0.2f)
                    .sound(SoundType.WOOL)));

    public static final DeferredBlock<FlagCarpet> BISEXUAL_FLAG_CARPET = registerBlock("bisexual_flag_carpet",
            () -> new FlagCarpet(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "bisexual_flag_carpet")))
                    .strength(0.2f)
                    .sound(SoundType.WOOL)));

    public static final DeferredBlock<FlagCarpet> DEMIBOY_FLAG_CARPET = registerBlock("demiboy_flag_carpet",
            () -> new FlagCarpet(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "demiboy_flag_carpet")))
                    .strength(0.2f)
                    .sound(SoundType.WOOL)));

    public static final DeferredBlock<FlagCarpet> DEMIGIRL_FLAG_CARPET = registerBlock("demigirl_flag_carpet",
            () -> new FlagCarpet(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "demigirl_flag_carpet")))
                    .strength(0.2f)
                    .sound(SoundType.WOOL)));

    public static final DeferredBlock<FlagCarpet> DEMINONBINARY_FLAG_CARPET = registerBlock("deminonbinary_flag_carpet",
            () -> new FlagCarpet(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "deminonbinary_flag_carpet")))
                    .strength(0.2f)
                    .sound(SoundType.WOOL)));

    public static final DeferredBlock<FlagCarpet> DEMIROMANTIC_FLAG_CARPET = registerBlock("demiromantic_flag_carpet",
            () -> new FlagCarpet(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "demiromantic_flag_carpet")))
                    .strength(0.2f)
                    .sound(SoundType.WOOL)));

    public static final DeferredBlock<FlagCarpet> DEMISEXUAL_FLAG_CARPET = registerBlock("demisexual_flag_carpet",
            () -> new FlagCarpet(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "demisexual_flag_carpet")))
                    .strength(0.2f)
                    .sound(SoundType.WOOL)));

    public static final DeferredBlock<FlagCarpet> GAY_FLAG_CARPET = registerBlock("gay_flag_carpet",
            () -> new FlagCarpet(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "gay_flag_carpet")))
                    .strength(0.2f)
                    .sound(SoundType.WOOL)));

    public static final DeferredBlock<FlagCarpet> GENDERFLUID_FLAG_CARPET = registerBlock("genderfluid_flag_carpet",
            () -> new FlagCarpet(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "genderfluid_flag_carpet")))
                    .strength(0.2f)
                    .sound(SoundType.WOOL)));

    public static final DeferredBlock<FlagCarpet> GENDERFLUX_FLAG_CARPET = registerBlock("genderflux_flag_carpet",
            () -> new FlagCarpet(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "genderflux_flag_carpet")))
                    .strength(0.2f)
                    .sound(SoundType.WOOL)));

    public static final DeferredBlock<FlagCarpet> GENDERQUEER_FLAG_CARPET = registerBlock("genderqueer_flag_carpet",
            () -> new FlagCarpet(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "genderqueer_flag_carpet")))
                    .strength(0.2f)
                    .sound(SoundType.WOOL)));

    public static final DeferredBlock<FlagCarpet> GRAYROMANTIC_FLAG_CARPET = registerBlock("grayromantic_flag_carpet",
            () -> new FlagCarpet(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "grayromantic_flag_carpet")))
                    .strength(0.2f)
                    .sound(SoundType.WOOL)));

    public static final DeferredBlock<FlagCarpet> GRAYSEXUAL_FLAG_CARPET = registerBlock("graysexual_flag_carpet",
            () -> new FlagCarpet(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "graysexual_flag_carpet")))
                    .strength(0.2f)
                    .sound(SoundType.WOOL)));

    public static final DeferredBlock<FlagCarpet> INTERSEX_FLAG_CARPET = registerBlock("intersex_flag_carpet",
            () -> new FlagCarpet(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "intersex_flag_carpet")))
                    .strength(0.2f)
                    .sound(SoundType.WOOL)));

    public static final DeferredBlock<FlagCarpet> LESBIAN_FLAG_CARPET = registerBlock("lesbian_flag_carpet",
            () -> new FlagCarpet(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "lesbian_flag_carpet")))
                    .strength(0.2f)
                    .sound(SoundType.WOOL)));

    public static final DeferredBlock<FlagCarpet> NONBINARY_FLAG_CARPET = registerBlock("nonbinary_flag_carpet",
            () -> new FlagCarpet(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "nonbinary_flag_carpet")))
                    .strength(0.2f)
                    .sound(SoundType.WOOL)));

    public static final DeferredBlock<FlagCarpet> OMNISEXUAL_FLAG_CARPET = registerBlock("omnisexual_flag_carpet",
            () -> new FlagCarpet(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "omnisexual_flag_carpet")))
                    .strength(0.2f)
                    .sound(SoundType.WOOL)));

    public static final DeferredBlock<FlagCarpet> PANSEXUAL_FLAG_CARPET = registerBlock("pansexual_flag_carpet",
            () -> new FlagCarpet(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "pansexual_flag_carpet")))
                    .strength(0.2f)
                    .sound(SoundType.WOOL)));

    public static final DeferredBlock<FlagCarpet> POLYSEXUAL_FLAG_CARPET = registerBlock("polysexual_flag_carpet",
            () -> new FlagCarpet(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "polysexual_flag_carpet")))
                    .strength(0.2f)
                    .sound(SoundType.WOOL)));

    public static final DeferredBlock<FlagCarpet> PROGRESS_PRIDE_FLAG_CARPET = registerBlock("progress_pride_flag_carpet",
            () -> new FlagCarpet(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "progress_pride_flag_carpet")))
                    .strength(0.2f)
                    .sound(SoundType.WOOL)));

    public static final DeferredBlock<FlagCarpet> QUEER_FLAG_CARPET = registerBlock("queer_flag_carpet",
            () -> new FlagCarpet(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "queer_flag_carpet")))
                    .strength(0.2f)
                    .sound(SoundType.WOOL)));

    public static final DeferredBlock<FlagCarpet> RAINBOW_FLAG_CARPET = registerBlock("rainbow_flag_carpet",
            () -> new FlagCarpet(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "rainbow_flag_carpet")))
                    .strength(0.2f)
                    .sound(SoundType.WOOL)));

    public static final DeferredBlock<FlagCarpet> TRANSGENDER_FLAG_CARPET = registerBlock("transgender_flag_carpet",
            () -> new FlagCarpet(BlockBehaviour.Properties.of().noOcclusion()
                    .setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(PrideCraft.MODID, "transgender_flag_carpet")))
                    .strength(0.2f)
                    .sound(SoundType.WOOL)));
