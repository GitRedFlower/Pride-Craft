package net.redflower.pride_craft.trim;
...
public class ModTrimMaterials {
    ...
    public static void bootstrap(BootstapContext<TrimMaterial> context) {
        ...
        register(context, ABROSEXUAL, ModItems.ABROSEXUAL_MATERIAL.get(), Style.EMPTY.withColor(TextColor.parseColor("#76CB92")), 0.7f);
        register(context, AGENDER, ModItems.AGENDER_MATERIAL.get(), Style.EMPTY.withColor(TextColor.parseColor("#B8F483")), 0.7f);
        register(context, AROACE, ModItems.AROACE_MATERIAL.get(), Style.EMPTY.withColor(TextColor.parseColor("#E28C00")), 0.7f);
        register(context, AROMANTIC, ModItems.AROMANTIC_MATERIAL.get(), Style.EMPTY.withColor(TextColor.parseColor("#3DA542")), 0.7f);
        register(context, ASEXUAL, ModItems.ASEXUAL_MATERIAL.get(), Style.EMPTY.withColor(TextColor.parseColor("#8D0085")), 0.7f);
        register(context, BIGENDER, ModItems.BIGENDER_MATERIAL.get(), Style.EMPTY.withColor(TextColor.parseColor("#C479A2")), 0.7f);
        register(context, BISEXUAL, ModItems.BISEXUAL_MATERIAL.get(), Style.EMPTY.withColor(TextColor.parseColor("#D70271")), 0.7f);
        register(context, DEMIBOY, ModItems.DEMIBOY_MATERIAL.get(), Style.EMPTY.withColor(TextColor.parseColor("#9AD9EB")), 0.7f);
        register(context, DEMIGIRL, ModItems.DEMIGIRL_MATERIAL.get(), Style.EMPTY.withColor(TextColor.parseColor("#FFAEC9")), 0.7f);
        register(context, DEMIROMANTIC, ModItems.DEMIROMANTIC_MATERIAL.get(), Style.EMPTY.withColor(TextColor.parseColor("#3DA542")), 0.7f);
        register(context, DEMISEXUAL, ModItems.DEMISEXUAL_MATERIAL.get(), Style.EMPTY.withColor(TextColor.parseColor("#6E0070")), 0.7f);
        register(context, GAY, ModItems.GAY_MATERIAL.get(), Style.EMPTY.withColor(TextColor.parseColor("#088D71")), 0.7f);
        register(context, GENDERFLUID, ModItems.GENDERFLUID_MATERIAL.get(), Style.EMPTY.withColor(TextColor.parseColor("#FF75A2")), 0.7f);
        register(context, GENDERFLUX, ModItems.GENDERFLUX_MATERIAL.get(), Style.EMPTY.withColor(TextColor.parseColor("#F47694")), 0.7f);
        register(context, GENDERQUEER, ModItems.GENDERQUEER_MATERIAL.get(), Style.EMPTY.withColor(TextColor.parseColor("#B899DD")), 0.7f);
        register(context, GRAYSEXUAL, ModItems.GRAYSEXUAL_MATERIAL.get(), Style.EMPTY.withColor(TextColor.parseColor("#B2B2B2")), 0.7f);
        register(context, INTERSEX, ModItems.INTERSEX_MATERIAL.get(), Style.EMPTY.withColor(TextColor.parseColor("#FFD800")), 0.7f);
        register(context, LESBIAN, ModItems.LESBIAN_MATERIAL.get(), Style.EMPTY.withColor(TextColor.parseColor("#D62C01")), 0.7f);
        register(context, NONBINARY, ModItems.NONBINARY_MATERIAL.get(), Style.EMPTY.withColor(TextColor.parseColor("#FEF436")), 0.7f);
        register(context, OMNISEXUAL, ModItems.OMNISEXUAL_MATERIAL.get(), Style.EMPTY.withColor(TextColor.parseColor("#FF9BCF")), 0.7f);
        register(context, PANSEXUAL, ModItems.PANSEXUAL_MATERIAL.get(), Style.EMPTY.withColor(TextColor.parseColor("#FF218D")), 0.7f);
        register(context, PROGRESS_PRIDE, ModItems.PROGRESS_PRIDE_MATERIAL.get(), Style.EMPTY.withColor(TextColor.parseColor("#603917")), 0.7f);
        register(context, QUEER, ModItems.QUEER_MATERIAL.get(), Style.EMPTY.withColor(TextColor.parseColor("#FFFFFF")), 0.7f);
        register(context, RAINBOW, ModItems.RAINBOW_MATERIAL.get(), Style.EMPTY.withColor(TextColor.parseColor("#E50204")), 0.7f);
        register(context, TRANSGENDER, ModItems.TRANSGENDER_MATERIAL.get(), Style.EMPTY.withColor(TextColor.parseColor("#F6A8B9")), 0.7f);
        register(context, DEMINONBINARY, ModItems.DEMINONBINARY_MATERIAL.get(), Style.EMPTY.withColor(TextColor.parseColor("#FBFF74")), 0.7f);
        register(context, GRAYROMANTIC, ModItems.GRAYROMANTIC_MATERIAL.get(), Style.EMPTY.withColor(TextColor.parseColor("#087D16")), 0.7f);
        register(context, POLYSEXUAL, ModItems.POLYSEXUAL_MATERIAL.get(), Style.EMPTY.withColor(TextColor.parseColor("#F61CB9")), 0.7f);
        register(context, TRANSFEMININE, ModItems.TRANSFEMININE_MATERIAL.get(), Style.EMPTY.withColor(TextColor.parseColor("#087D16")), 0.7f);
        register(context, TRANSMASCULINE, ModItems.TRANSMASCULINE_MATERIAL.get(), Style.EMPTY.withColor(TextColor.parseColor("#087D16")), 0.7f);
    }



    public static void register(BootstapContext<TrimMaterial> context, ResourceKey<TrimMaterial> trimMaterialResourceKey, Item item,
